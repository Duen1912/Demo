...
namespace DXQLSB.Model
{
    class Connection
    {
        public static string sqlString = @System.Configuration.ConfigurationManager.ConnectionStrings["QLSB"].ConnectionString;
        ...
        public static string ExcuteScalar(string strQuery, CommandType cmdtype, string[] para, object[] values)
        {
            ...
            catch (Exception ex)
            {
                ...
                //MessageBox.Show("Error ExcuteScalar 368 :" + ex.Message);
